    ...
    function (e) {
      ...
      function x() {
        const e = t.params.zoom,
          s = m.ImagesWrapEl.getAttribute("data-swiper-zoom") || e.maxRatio;
        if (e.limitToOriginalSize && m.ImagesEl && m.ImagesEl.naturalWidth) {
          const e = m.ImagesEl.naturalWidth / m.ImagesEl.offsetWidth;
          return Math.min(e, s);
        }
        return s;
      }
        ...
        if (((l = !1), (o = !1), u.push(e), !(u.length < 2))) {
          if (((l = !0), (m.scaleStart = y()), !m.slideEl)) {
            ...
            if (
              ...
              (m.ImagesEl = a),
              (m.ImagesWrapEl = a
                ? E(m.ImagesEl, `.${s.containerClass}`)[0]
                : void 0),
              !m.ImagesWrapEl)
            )
              return void (m.ImagesEl = void 0);
            m.maxRatio = x();
          }
          if (m.ImagesEl) {
            const [e, t] = (function () {
              if (u.length < 2) return { x: null, y: null };
              const e = m.ImagesEl.getBoundingClientRect();
              return [
            ...
            (m.originX = e),
              (m.originY = t),
              (m.ImagesEl.style.transitionDuration = "0ms");
          }
          p = !0;
        }
      }
        ...
        i >= 0 && (u[i] = e),
          u.length < 2 ||
            ...
            m.ImagesEl &&
              ...
              (m.ImagesEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`)));
      }
      function C(e) {
        if (!S(e)) return;
        ...
        i >= 0 && u.splice(i, 1),
          l &&
            ...
            m.ImagesEl &&
              ...
              (m.ImagesEl.style.transitionDuration = `${t.params.speed}ms`),
              (m.ImagesEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`),
              (c = a.scale),
              (p = !1),
              a.scale > 1 && m.slideEl
      ...
      function L(e) {
        if (
          ...
          return;
        const s = t.zoom;
        if (!m.ImagesEl) return;
        if (!h.isTouched || !m.slideEl) return;
        h.isMoved ||
          ((h.width = m.ImagesEl.offsetWidth || m.ImagesEl.clientWidth),
          (h.height = m.ImagesEl.offsetHeight || m.ImagesEl.clientHeight),
          (h.startX = d(m.ImagesWrapEl, "x") || 0),
          (h.startY = d(m.ImagesWrapEl, "y") || 0),
          (m.slideWidth = m.slideEl.offsetWidth),
          (m.slideHeight = m.slideEl.offsetHeight),
          (m.ImagesWrapEl.style.transitionDuration = "0ms"));
        ...
        (h.currentX =
          ...
          (g.prevTime = Date.now()),
          (m.ImagesWrapEl.style.transform = `translate3d(${h.currentX}px, ${h.currentY}px,0)`);
      }
      function I() {
        const e = t.zoom;
        m.slideEl &&
          ...
          (m.ImagesEl &&
            (m.ImagesEl.style.transform = "translate3d(0,0,0) scale(1)"),
          m.ImagesWrapEl &&
            (m.ImagesWrapEl.style.transform = "translate3d(0,0,0)"),
          m.slideEl.classList.remove(`${t.params.zoom.zoomedSlideClass}`),
          (e.scale = 1),
          (c = 1),
          (m.slideEl = void 0),
          (m.ImagesEl = void 0),
          (m.ImagesWrapEl = void 0),
          (m.originX = 0),
          (m.originY = 0));
      }
      function z(e) {
        ...
        if (!m.slideEl) {
          ...
          s &&
            ...
            (m.ImagesEl = s),
            (m.ImagesWrapEl = s
              ? E(m.ImagesEl, `.${a.containerClass}`)[0]
              : void 0);
        }
        if (!m.ImagesEl || !m.ImagesWrapEl) return;
        ...
        (s.scale = z || A),
          ...
          !e || (1 === c && z)
            ...
            : ((L = m.slideEl.offsetWidth),
              ...
              (d = l + L / 2 - i),
              (p = o + I / 2 - r),
              (v = m.ImagesEl.offsetWidth || m.ImagesEl.clientWidth),
              (b = m.ImagesEl.offsetHeight || m.ImagesEl.clientHeight),
              (y = v * s.scale),
              (S = b * s.scale),
          ...
          (m.ImagesWrapEl.style.transitionDuration = "300ms"),
          (m.ImagesWrapEl.style.transform = `translate3d(${u}px, ${g}px,0)`),
          (m.ImagesEl.style.transitionDuration = "300ms"),
          (m.ImagesEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`);
      }
      function A() {
        const e = t.zoom,
          s = t.params.zoom;
          ...
          t.zoom.enabled &&
            (function () {
              ...
              (h.minX = Math.min(m.slideWidth / 2 - d / 2, 0)),
                ...
                (m.ImagesWrapEl.style.transitionDuration = `${o}ms`),
                (m.ImagesWrapEl.style.transform = `translate3d(${h.currentX}px, ${h.currentY}px,0)`);
            })();
        }),
        a("doubleTap", (e, s) => {
